...
export default function ConfiguracoesSistemaPage() {
  ...
  function restaurarPadrao() {
    ...
    setRemoverLogo(true);
    setErro("");
    toast.info("Preview restaurado para o padrao. Salve para aplicar.");
  }
  ...
  async function gerarPaletaDaLogo() {
    ...
    try {
      ...
      const message = error.message || "Nao foi possivel gerar a paleta da logo.";
      setErro(message);
      toast.error(message);
    } finally {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      setRemoverLogo(false);
      toast.success("Configuracoes visuais atualizadas com sucesso.");
    } catch (error) {
      const message = error.message || "Nao foi possivel salvar as configuracoes.";
      setErro(message);
      toast.error(message);
    } finally {
      setSalvando(false);
    ...
    <Layout title="Configuracoes">
      <div className="form-shell form-shell--wide">
        <PageHeader
          ...
          description="Organize o nome exibido, a descricao, a logo e a paleta visual usada pelo frontend."
        />
        ...
        <div className="dashboard-grid settings-grid settings-grid--simple">
          <form className="page-card form-card" onSubmit={handleSubmit}>
            <div className="form-section">
              <h3 className="section-title">Identidade basica</h3>
              ...
              <div className="section-header-inline">
                <div>
                  ...
                  <p className="section-subtitle">
                    O preview abaixo reflete o que sera exibido na barra superior e na tela de login.
                  </p>
                </div>
            ...
            <div className="settings-status-grid">
              <article className="metric-card">
                <span className="metric-card__label">Ultima atualizacao</span>
              ...
              <article className="metric-card">
                ...
                <strong className="metric-card__value">
                  {hasLogo ? "Imagem personalizada" : "Monograma padrao"}
                </strong>
              </article>
            </div>
            ...
            <div className="settings-preview__cards">
              <article className="info-card">
                ...
                <p className="table-cell-meta">
                  A alteracao aplica nome, favicon, cores e identidade da interface neste navegador.
                </p>
              </article>

              <article className="info-card">
                <span className="info-card__label">Escopo atual</span>
                <strong className="info-card__value">Persistencia local</strong>
                <p className="table-cell-meta">
                  Essas configuracoes ficam salvas no `localStorage` e servem como base visual do frontend.
                </p>
              </article>
            </div>
          </aside>
